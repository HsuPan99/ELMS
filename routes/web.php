...
Route::resource('loan', 'LoanformController'); //7 (get-4/post-1/put-1/delete-1)
Route::resource('payment', 'PaymentformController'); //7 (get-4/post-1/put-1/delete-1)
...
Route::get('loan/{id}', 'LoanController@confirm')->name('loan.confirm'); //7 (get-4/post-1/put-1/delete-1)
// Route::get('loan/{id}', 'LoanController@confirmloan')->name('loan.confirmloan'); //7 (get-4/post-1/put-1/delete-1)
...
Route::resource('financialinfos', 'FinancialinfoController'); //7 (get-4/post-1/put-1/delete-1)
 ...
 Route::resource('confirms', 'LoanconfirmController'); //7 (get-4/post-1/put-1/delete-1)
